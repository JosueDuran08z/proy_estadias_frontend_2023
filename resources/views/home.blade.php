        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 col-xl-8 col-xxl-8">
            ...
            <div id="carrouselPrincipal" class="carousel carousel-dark slide" data-bs-ride="carousel">
                <div class="carousel-indicators">
                    ...
                    <button type="button" data-bs-target="#carrouselPrincipal" data-bs-slide-to="8"></button>
                    </div>
                    <div class="carousel-inner">
                    <div class="carousel-item active">
                        <a href="https://5toinformeds.guanajuato.gob.mx/" target="_blank">
                            <img src="{{ url('img/banner/5informe.jpg') }}" class="d-block responsive" alt="..."/>
                        </a>
                    </div>
                    ...
                    <div class="carousel-item">
                        <a href="#" target="_blank">
                            <img src="{{ url('img/banner/campaña.jpeg') }}" class="d-block responsive" alt="..."/>
                        </a>
                    </div>
                    <div class="carousel-item">
                    ...
                    <!-- <div class="carousel-item">
                        <a href="#">
                            <img src="{{ url('img/banner/banner_salamanca.png') }}" class="d-block responsive" alt="..."/>
                        </a>
                    </div> -->
                    <!-- <div class="carousel-item">
                        <a href="#">
                            <img src="{{ url('img/banner/banner_leon.png') }}" class="d-block responsive" alt="..."/>
                        </a>
                    </div> -->
                    <!-- <div class="carousel-item">
                        <a href="#">
                            <img src="{{ url('img/banner/banner_irapuato.png') }}" class="d-block responsive" alt="..."/>
                        </a>
                    </div> -->
                    <!-- <div class="carousel-item">
                        <a href="#">
                            <img src="{{ url('img/banner/banner_guanajuato.png') }}" class="d-block responsive" alt="..."/>
                        </a>
                    </div> -->
                    <!-- <div class="carousel-item">
                        <a href="#">
                            <img src="{{ url('img/banner/banner_celaya.png') }}" class="d-block responsive" alt="..."/>
                        </a>
                    </div> -->
                    <!--<div class="carousel-item">
                        <a href="#">
                            <img src="{{ url('img/banner/banner10.png') }}" class="d-block responsive" alt="..."/>
                        </a>
                    </div>
                    <div class="carousel-item">
                        <a href="#">
                            <img src="{{ url('img/banner/banner11.png') }}" class="d-block responsive" alt="..."/>
                        </a>
                    </div>
                    <div class="carousel-item">
                        <a href="#">
                            <img src="{{ url('img/banner/banner12.jpg') }}" class="d-block responsive" alt="..."/>
                        </a>
                    </div>-->
                </div>
