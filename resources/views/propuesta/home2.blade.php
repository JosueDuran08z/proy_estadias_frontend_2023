...
<div class="container tituloss">
    ...
    <a href="{{url('propuesta2')}}">Prouesta 3</a>
    <div class="row">
    ...
    <div  class="row">
        <div class="col-md-8">
            <div class="card cardCustom">
                <div class="lt-head">
                    <h4 class="encabezadoSeccion"><center>Descarga y Duplicado de Certificado Electrónico </center></h4>
                </div>
            </div>
                
                <br>
                <label>Para iniciar el trámite de tu certificado electrónico necesitaras los siguientes requisitos</label>
                <ul>
                    <li>Foto de frente, fondo blanco</li>
                    <li>Foto de INE anverso y reverso</li>
                    <li>Foto de Certificado de Primaria(En caso de ser secundaría)</li>
                </ul>
                <label>El trámite es facíl y gratuito, para iniciar con tu proceso entra en el siguiente link:</label>
                <br>
                <br>
                <center><button class="btn btn-primary btn-lg rounded">Iniciar Proceso..</button></center>
        </div>
        <div class="col-md-4">
